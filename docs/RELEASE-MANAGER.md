...
That's it. CI builds the artifacts and creates the GitHub Release automatically.
...
1. **Verify main is stable**
   - All PRs merged
   - Build passes: `xcodebuild -scheme NeoNV -destination 'platform=macOS' build`
   - No open P0/P1 issues: `bd ready`
...
3. **Monitor CI**
   - Go to: https://github.com/msnodderly/neonv/actions
   - Watch the tag-triggered workflow
   - CI will:
...
1. **Verify the release**
   ...
   - Download and test the DMG on a clean machine
